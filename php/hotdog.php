                    ...
                    echo '
                        ...
                        <div class="menu__option" data-aos="fade-up" data-aos-delay="' . (100 * (array_search($k, $kategoriak) + 1)) . '">
                            ...
                            <div class="button-container">
                                ...
                                <button class="order-btn add-to-cart" data-item-id="' . htmlspecialchars($k["id"]) . '" data-item="' . htmlspecialchars($k['nev']) . '" data-image="../kepek/5/' . htmlspecialchars($k['kep_url']) . '" onclick="addToCartOnly(\'' . htmlspecialchars($k["id"]) . '\')" title="Kosárba rakás">
