                    ...
                    <div class="flex-col">
                        <div class="menu__option" data-aos="fade-up" data-aos-delay="' . (100 * (array_search($k, $kategoriak) + 1)) . '">
                            <div class="image-wrapper">
                                <img src="../kepek/9/' . htmlspecialchars($k['kep_url']) . '" alt="' . htmlspecialchars($k['nev']) . '">
                            </div>
                    ...
                    <div class="custom-modal" id="modal-' . htmlspecialchars($k['id']) . '">
                        <div class="custom-modal-content">
                            ...
                            <div class="custom-modal-body">
                                <img src="../kepek/9/' . htmlspecialchars($k['kep_url']) . '" class="img-fluid mb-3" alt="' . htmlspecialchars($k['nev']) . '">
