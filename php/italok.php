...
<body>
    ...
    <div class="content-wrapper">
        <main>
            <div class="title-container">
                <h1 class="page-title">Italok</h1>
            </div>
            <?php
            include_once './adatbazisra_csatlakozas.php';

            $kategoriak_sql = "SELECT * FROM etel WHERE kategoria_id = 9;";
                    ...
                    <div class="flex-col">
                        <div class="menu__option" data-aos="fade-up" data-aos-delay="' . (100 * (array_search($k, $kategoriak) + 1)) . '">
                            <div class="image-wrapper">
                                <img src="../kepek/italok/' . htmlspecialchars($k['kep_url']) . '" alt="' . htmlspecialchars($k['nev']) . '">
                            </div>
                    ...
                    <div class="custom-modal" id="modal-' . htmlspecialchars($k['id']) . '">
                        <div class="custom-modal-content">
                            ...
                            <div class="custom-modal-body">
                                <img src="../kepek/italok/' . htmlspecialchars($k['kep_url']) . '" class="img-fluid mb-3" alt="' . htmlspecialchars($k['nev']) . '">
                            ...
                            <div class="custom-modal-footer">
                                <button type="button" class="order-btn add-to-cart" data-item-id="' . htmlspecialchars($k["id"]) . '" data-item="' . htmlspecialchars($k['nev']) . '" data-image="../kepek/italok/' . htmlspecialchars($k['kep_url']) . '" onclick="addToCartAndClose(\'modal-' . htmlspecialchars($k['id']) . '\', \'' . htmlspecialchars($k["id"]) . '\')">Kosárba rakás</button>
    ...
    <script>
        ...
        function addToCartAndClose(modalId, itemId) {
            ...
            animateCartAdd(button, imageSrc);
            addToCart(itemId);
            ...
            fetch("kosarba_rakas.php", {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        updateCartCount(); // A cart.js-ben definiált függvény
                    } else {
        ...
        function animateCartAdd(button, imageSrc) {
            ...
            cartAnimationItem.style.left = `${buttonRect.left + buttonRect.width / 2 - 25}px`;
